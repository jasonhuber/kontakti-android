...
data class Person(
    ...
    @SerializedName("contact_cadence") val contactCadence: String? = null,
    @SerializedName("contact_on_birthday") val contactOnBirthday: Boolean? = null,
    @SerializedName("contact_on_holidays") val contactOnHolidays: Boolean? = null,
    val notes: String?,
